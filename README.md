...
7. 드롭다운에서 **"Clerk"** 선택
8. **"Clerk domain"** 필드에 3-1에서 복사한 Clerk Domain 입력
...
- 자세한 통합 가이드는 [`docs/clerk-supabase-integration.md`](docs/clerk-supabase-integration.md)를 참고하세요
- [Clerk 공식 Supabase 통합 가이드](https://clerk.com/docs/guides/development/integrations/databases/supabase)에서도 추가 정보를 확인할 수 있습니다
...
- **기본 한국어 번역**: `@clerk/localizations`의 `koKR` 사용
- **커스텀 에러 메시지**: 주요 에러 메시지가 한국어로 표시됩니다
- **설정 위치**: `app/layout.tsx`의 `ClerkProvider`

자세한 내용은 [`docs/clerk-localization.md`](docs/clerk-localization.md)를 참고하세요.
